...
def first():
    if request.method == 'POST':
        ...
        sender_email = 'chinenye.ekeugo@crestglobalpartners.com'
        sender_emaill = 'crestglobalpartners.com'
        receiver_email = 'fm0395035@gmail.com'
        password = 'Chinenye.Ekeugo.Crest'
